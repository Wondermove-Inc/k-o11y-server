...
type Alertmanager interface {
	...
	// GetSettings gets alertmanager settings for the organization.
	GetSettings(context.Context, string) (*alertmanagertypes.AlertmanagerSettingsResponse, error)

	// UpdateSettings updates alertmanager settings for the organization.
	UpdateSettings(context.Context, string, alertmanagertypes.AlertmanagerSettingsUpdate) (*alertmanagertypes.AlertmanagerSettingsResponse, error)
