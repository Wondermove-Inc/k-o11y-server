...
function DashboardDescription(props: DashboardDescriptionProps): JSX.Element {
	...
	return (
		<Card className="dashboard-description-container">
			<div className="dashboard-header" style={isStaticDashboard ? { justifyContent: 'flex-end' } : undefined}>
				{!isStaticDashboard && (
			...
			<section className="dashboard-details">
				<div className="left-section">
					...
					{isDashboardLocked && !isStaticDashboard && <LockKeyhole size={14} />}
				</div>
				<div className="right-section">
						...
						content={
							<div className="menu-content">
								<section className="section-1">
									{!isStaticDashboard && (isAuthor || user.role === USER_ROLES.ADMIN) && (
										<Tooltip
											title={
									...
									{!isStaticDashboard && !isDashboardLocked && editDashboard && (
										<Button
											type="text"
					...
					{!isStaticDashboard && !isDashboardLocked && addPanelPermission && (
						<Button
