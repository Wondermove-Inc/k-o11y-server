...
function GraphLayout(props: GraphLayoutProps): JSX.Element {
	...
	// Filter out any layout items that don't have valid x, y, w, h values
	...
	// Early return if no valid layout to prevent ReactGridLayout errors
	if (isDashboardEmpty || validLayout.length === 0) {
	...
	return (
		...
		>
			...
			{isDashboardLocked && !isStaticDashboard && (
