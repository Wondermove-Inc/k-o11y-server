...
import K8sRolloutsList from './Rollouts/K8sRolloutsList';
				...
				<div className="k8s-quick-filters-category-label">
					<div className="k8s-quick-filters-category-label-container">
						<IterationCcw
							...
							className="k8s-quick-filters-category-label-icon"
						/>
						<Typography.Text>Rollouts</Typography.Text>
					</div>
				</div>
			),
			key: K8sCategories.ROLLOUTS,
			showArrow: false,
			children: (
				<QuickFilters
					source={QuickFiltersSource.INFRA_MONITORING}
					config={GetRolloutsQuickFiltersConfig(dotMetricsEnabled)}
					handleFilterVisibilityChange={handleFilterVisibilityChange}
					onFilterChange={handleFilterChange}
				/>
			),
			...
			<div className="infra-monitoring-container">
				<div className="k8s-container">
					...
					>
						...
						{selectedCategory === K8sCategories.ROLLOUTS && (
							<K8sRolloutsList
								isFiltersVisible={showFilters}
								handleFilterVisibilityChange={handleFilterVisibilityChange}
								quickFiltersLastUpdated={quickFiltersLastUpdated}
