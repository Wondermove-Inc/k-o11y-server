...
export const rolloutWidgetInfo = [
	{
...
export const getRolloutMetricsQueryPayload = (
	...
	const k8sRolloutNameKey = dotMetricsEnabled
		? 'k8s.rollout.name'
		: 'k8s_rollout_name';
								...
								items: [
									{
										...
										key: {
											...
											id: 'k8s_rollout_name--string--tag--false',
											key: k8sRolloutNameKey,
											type: 'tag',
										},
										op: '=',
