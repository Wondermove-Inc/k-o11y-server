...
export const InsightPage = Loadable(
	() => import(/* webpackChunkName: "InsightPage" */ 'pages/Insight'),
);
...
export const TraceDetailEmbed = Loadable(
	() =>
		import(
			/* webpackChunkName: "TraceDetailEmbed Page" */ 'pages/TraceDetailEmbed'
		),
);
...
export const ServiceMapPage = Loadable(
	() =>
		import(/* webpackChunkName: "ServiceMap" */ 'pages/ServiceMap'),
);
...
export const ClickHousePage = Loadable(
	() => import(/* webpackChunkName: "ClickHousePage" */ 'pages/ClickHousePage'),
);
